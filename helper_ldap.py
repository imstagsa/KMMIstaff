# Copyright (C) 2008, Matt Butcher
# This software is released under a dual license. You may 
# select between an MIT style license or the GPL v. 2. The
# text of each license is included in this package. Or you 
# may visit 
