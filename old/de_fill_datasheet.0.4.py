...
#bdb9alist = de_read_sheet('dbdb9a', 11)

USER_BASE = "nettsInstitutionCode=2007051,o=institutions,dc=infomity,dc=net"
EMPTY_SIZE = "cn=mboxEmptySize,o=settings,infomityServiceCode=MGBOX,o=services,nettsInstitutionCode=2007051,o=institutions,dc=infomity,dc=net"
PACKAGE_INFO = "o=packageContracts,nettsInstitutionCode=2007051,o=institutions,dc=infomity,dc=net"
SERVICE_CONTRACTS = "o=contracts,nettsInstitutionCode=2007051,o=institutions,dc=infomity,dc=net"

#str = try_ldap(EMPTY_SIZE, "(objectClass=*)", "numericValue") #EMPTY_SIZE
#print str[0]
#try_ldap(PACKAGE_INFO,"contractFlag=TRUE", "infomityServicePackageCode") #PACKAGE_INFO

services = try_ldap(SERVICE_CONTRACTS, "(contractFlag=TRUE)", "infomityServiceCode")
service = Service()
for serv in services:
    #print serv
    str = "infomityServiceCode=" + serv + ",o=services,nettsInstitutionCode=2007051,o=institutions,dc=infomity,dc=net"
    #print str
    infomityServiceName = try_ldap2(str, "(objectClass=*)", "infomityServiceName")
    if len(infomityServiceName) > 0:
        print infomityServiceName[0]
