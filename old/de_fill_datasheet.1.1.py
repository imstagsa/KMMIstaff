...
#dbst:/infomity-mainte/bin/stcheck/KimSystemini_daily_report.sh 
...
def rewrite_workbook(workbook, tickets):
    ...
    print "rownum_dbdb" + str(rownum_dbdb)
    print "total_row_dbdb" + str(total_row_dbdb)
    if rownum_dbdb < total_row_dbdb - 11:
        for rownum in range(rownum_dbdb, total_row_dbdb - 11):
